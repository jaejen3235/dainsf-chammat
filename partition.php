    ...
    <script>
        ...
        function displayTemperatureData(data) {
            ...
            data.forEach(function(item) {
                const warehouseName = warehouseNames[item.machine_id] || item.machine_name || item.machine_id;
                ...
                html += `
                    <div class="temperature-card">
                        ...
                        <div class="temperature-value">
                            <div>
                                <span class="temp-number">${temperature.toFixed(1)}</span>
                                <span class="temp-unit">°C</span>
                            </div>
                            <span class="temp-status ${statusClass}">${statusText}</span>
                        </div>
                    </div>
                `;
            });
            ...
            data.forEach(function(item) {
                ...
                html += `
                    <tr>
                        ...
                        <td style="text-align: center;"><span class="status-badge status-${status}">${status}</span></td>
                    </tr>
                `;
            });
