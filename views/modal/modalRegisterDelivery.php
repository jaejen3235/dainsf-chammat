<div class="modal" id="modalRegisterDelivery">
	<div class="modal-content">
		<div class="modal-header">
			<span class='modal-title'>납품 등록</span>
		...
		<div class="modal-body center" style="overflow:auto">
            <form id='frm'>
                ...
                <input type='hidden' name='mode' id='mode' value='registerDelivery' />
    ...
    try {
        ...
        if(btnClose) {
            btnClose.addEventListener('click', function() {
                clean();
                closeModal('modalRegisterDelivery');
            });
        }
    } catch(e) {}
...
const setter = (data) => {
    if (data) {        
        ...
        document.getElementById('delivery_order_date').innerHTML = data.delivery_date;
        document.getElementById('delivery_date').value = data.delivery_date;
        document.getElementById('delivery_order_qty').innerHTML = comma(data.delivery_qty);
        document.getElementById('delivery_qty').value = data.delivery_qty;
        document.getElementById('current_stock_qty').innerHTML = comma(data.stock_qty);
