                ...
                <table class="item-table">
                    ...
                    <tbody id="invoiceItems">
                        ...
                        <tr>
                            ...
                            <td class="text-left" id="invoiceItemName"></td>
                            <td class="text-center" id="invoiceStandard"></td>
                            <td class="text-right" id="invoiceQty"></td>
                            <td class="text-right" id="invoiceUnitPrice"></td>
                            <td class="text-right" id="invoiceSupplyAmount"></td>
                            <td class="text-right" id="invoiceTax"></td>
