<link rel="stylesheet" type="text/css" href="/assets/css/일반위생관리_및_공정점검표1_style.css" />
<style>
...
<script>
    // ── 좌측 패널 CRUD 함수 ──
    const HaccpResourceKey = 'HC08_일반위생관리_및_공정점검표1';
    const MetaConfig = {
        page_no: 1,
        write_date: 'HC08_writeDate',
        writer: 'HC08_writer',
        inspector: 'HC08_actor',
        action_person: 'HC08_confirmer',
    };
    ...
    <div class='content-wrapper'>
        <div class="ccp1bp-split-container">
            ...
            <div class="ccp1bp-right-panel">
                <?php
                    $lines = file(__DIR__ . '/HC08_일반위생관리_및_공정점검표1.html');
