<link rel="stylesheet" type="text/css" href="/assets/css/중요관리점(CCP)_검증점검표_style.css" />
<style>
...
<script>
    // ── 좌측 패널 CRUD 함수 ──
    const HaccpResourceKey = 'HC10_중요관리점(CCP)_검증점검표';
    const MetaConfig = {
        page_no: 1,
        write_date: 'HC10_writeDate',
        writer: 'HC10_writer',
        inspector: 'HC10_inspector',
        action_person: 'HC10_approver',
    };
    ...
    <div class='content-wrapper'>
        <div class="ccp1bp-split-container">
            ...
            <div class="ccp1bp-right-panel">
                <?php
                    $lines = file(__DIR__ . '/HC10_중요관리점(CCP)_검증점검표.html');
