<link rel="stylesheet" type="text/css" href="/assets/css/방충_및_방서점검표_style.css" />
<style>
...
<script>
    // ── 좌측 패널 CRUD 함수 ──
    const HaccpResourceKey = 'HC05_방충_및_방서점검표';
    const MetaConfig = {
        page_no: 1,
        write_date: 'HC05_writeDate',
        writer: 'HC05_writer_name',
        inspector: 'HC05_inspector',
        action_person: 'HC05_action_person',
    };
    ...
    <div class='content-wrapper'>
        <div class="ccp1bp-split-container">
            ...
            <div class="ccp1bp-right-panel">
                <?php
                    $lines = file(__DIR__ . '/HC05_방충_및_방서점검표.html');
