<link rel="stylesheet" type="text/css" href="/assets/css/원부재료_입고_점검표_style.css" />
<style>
...
<script>
    // ── 좌측 패널 CRUD 함수 ──
    const HaccpResourceKey = 'HC07_원부재료_입고_점검표';
    const MetaConfig = {
        page_no: 1,
        // HC07 폼에서 대표 메타 필드 1세트만 사용(일단 MVP)
        write_date: 'HC07_inDate_1',
        writer: 'HC07_writer_1',
        inspector: 'HC07_writer_1',
        action_person: 'HC07_approver_1',
    };
    ...
    function ccp1bpEdit(uid) {
        // View와 동일: payload 적용 후 Save에서 update 수행
        ccp1bpView(uid);
    }
    ...
    <div class='content-wrapper'>
        <div class="ccp1bp-split-container">
            ...
            <div class="ccp1bp-right-panel">
                <?php
                    $lines = file(__DIR__ . '/HC07_원부재료_입고_점검표.html');
