<link rel="stylesheet" type="text/css" href="/assets/css/일반위생관리_및_공정점검표2_style.css" />
<style>
...
<script>
    // ── 좌측 패널 CRUD 함수 ──
    const HaccpResourceKey = 'HC09_일반위생관리_및_공정점검표2';
    const MetaConfig = {
        page_no: 1,
        write_date: 'HC09_writeDate',
        writer: 'HC09_writer',
        inspector: 'HC09_inspector',
        action_person: 'HC09_approver',
    };
    ...
    <div class='content-wrapper'>
        <div class="ccp1bp-split-container">
            ...
            <div class="ccp1bp-right-panel">
                <?php
                    $lines = file(__DIR__ . '/HC09_일반위생관리_및_공정점검표2.html');
