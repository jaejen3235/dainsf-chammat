<div class='main-container'>
    <div class="page-title"><i class='bx bxs-food-menu'></i> 사원 관리</div>  
...
window.addEventListener('DOMContentLoaded', ()=>{
    ...
    try {
        ...
        if (btnExcelDownload) {
            btnExcelDownload.addEventListener('click', downloadEmployeeExcel);
        }
    } catch(e) {}
...
const downloadEmployeeExcel = () => {
    ...
    try {
        ...
        if (searchText && searchText.value !== '') {
            where += ` and (name like '%${searchText.value}%' or department like '%${searchText.value}%')`;
        }
    } catch(e) {}
