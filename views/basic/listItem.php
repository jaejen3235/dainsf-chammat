<div class='main-container'>
    <div class="page-title"><i class='bx bxs-food-menu'></i> 품목 관리</div> 
    <div class='search-wrapper'>
        <div class='search-box'>
            <div class='search-section'>
                <div class='search-input'>
                    <input type="text" id='searchText' placeholder="구분, 품목명, 품목코드 검색"
            ...
            <div class='button-box'>
                <input type='button' class='btn-large orange' id='btnOpenModal' value='품목 등록' />
...
window.addEventListener('DOMContentLoaded', ()=>{
    ...
    try {
        ...
        if (btnExcelDownload) {
            btnExcelDownload.addEventListener('click', downloadItemExcel);
        }
    } catch(e) {}
...
const getItemList = async ({
    ...
    try {
        ...
        if(searchText) {
            if(searchText.value != '') {
                where += ` and (classification like '%${searchText.value}%' or item_name like '%${searchText.value}%' or item_code like '%${searchText.value}%')`;
            }
        }
    } catch(e) {}
...
const generateTableContent = (data) => {
    ...
    return data.data.map(item => `
        <tr>
            ...
            <td class='center'>
                <input type='button' class='btn-small grey' value='수정' onclick='modifyItem(${item.uid})' />
                <input type='button' class='btn-small danger' value='삭제' onclick='deleteItem(${item.uid})' />
            </td>
        </tr>
    `).join('');
};
